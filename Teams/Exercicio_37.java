...
public class Exercicio_37 {
    public static void main(String[] args) {
        /*
        * Exercício 37) Faça um programa que receba o código correspondente
        * ao cargo de um funcionário e seu salário atual e mostre o cargo,
        * o valor do aumento e seu novo salário. Os cargos estão na seguinte
        * tabela:
        *
