...
public class Exercicio_46 {
    public static void main(String[] args) {
        /*
        * Exercício 46) Construa um algoritmo que calcule o consumo de combustível
        * de um veículo qualquer baseado nas informações de quilometragem  inicial
        * e final de um percurso, e a quantidade de gasolina consumida em litros.
        * Caso o consumo esteja entre 10 e 16 litros/km mostre a mensagem “consumo
        * normal”, caso seja maior que 16 litros/km apresente a mensagem “consumo
        * anormal”.
        */
