...
public class Exercicio_48 {
    public static void main(String[] args) {
        /*
        * Exercício 48) Escreva um programa que calcule o valor total de aluguel
        * e taxas a serem cobrados de um morador. Solicite o valor do aluguel, o
        * valor do condomínio, considere que o valor do metro cubico do gas é de
        * R$ 1,80 e o valor da taxa de consumo de agua é de R$ 0,60 por metro
        * cúbico de agua consumida. Apresente também o valor de 5% do valor total
        * do aluguel que pode ser dado como desconto caso seja pago 5 dias antes
        * do vencimento.
        */
