...
public class Exercicio_65 {
    public static void main(String[] args) {
        /*
        * Exercício 65) Faça um algoritmo que leia um número inteiro e calcule
        * o seu fatorial. Se o número for negativo, informe que o valor é
        * inválido. Sabemos que o fatorial de um número n, representado por n!,
        * é dado por: n * (n-1) * (n-2) * ... * 1, para n > 0 e n! = 1 para
        * n = 0
        */
